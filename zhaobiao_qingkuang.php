...
require("conn.php"); 
$result=mysql_query("select * from info_zhaobiao where computer_id='".$x."'",$conn);

?>
<table border="1" width="800" align="center">
<tr><td>序号</td><td>招标ID</td><td>药品名称</td><td>投标公司</td><td>投标时间</td><td>招标金额</td>
...
{
	$y=$row["zhaobiao_id"];
	$str1=mysql_query("select * from info_toubiao where zhaobiao_id='$y'");
