...
<? 
        ...
        $str="select computer_id from user_toubiao where username='".$username."'";
...
<td width="83%" height="100%"> 
    <li style="font-size:30px; color:#F00; text-align: center; ">投标首页</li></td>

<td width="5%"><li style="float:left"><a href="toubiao1.php">首页</a></li></td>

<td width="7%"><li style="float:right" ><a href="toubiao_yonghushezhi.php">用户中心</a></li></td>

<td width="5%"><li style="float:right" ><a href="login.html">注销</a></li></td>
</tr>
</table>     
</div>
...
<tr>
<td width="30%"  height="100px" id="tx" ><img src="images/4.jpg"  width="100%" height="100%" /></td>
                        
<td width="70%" id="yhm"> 
当前用户：<? echo $username ?><br />
...
<tr height="30px">
<td width="99" height="30px"><a href="toubiao_information.php" target="myiframe">查询招标信息</a></td></tr>
                    
<tr height="30px">
<td width="99" height="30px"><a href="toubiao_chaxun.php" target="myiframe">查询投标情况</a></td></tr>
